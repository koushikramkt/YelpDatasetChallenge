...
# https://github.com/wenbert/tide_converter/blob/master/gui.py
...
class App:
    ...
    def start(self):
        self.master.title("Yelp Dataset")
        
        self.now = datetime.datetime.now()
        label01 = "Select the file to Process"
        ...
        Label(self.master, text="Radio: ").grid(row=3, sticky=N)
        ADJUSTMENTS = [
            ("Radio 1", "1"),
            ("Radio 2", "2")
        ]
